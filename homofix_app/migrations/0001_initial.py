# Generated by Django 4.1.7 on 2023-02-27 08:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('New', 'New'), ('in_process', 'In Process'), ('cancelled', 'Cancelled'), ('completed', 'Completed')], default='New', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Active', 'Active'), ('Deactivate', 'Deactivate'), ('Hold', 'Hold')], default='Active', max_length=50)),
                ('created_at', models.DateField(auto_now_add=True)),
