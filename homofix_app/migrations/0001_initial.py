    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('joining_date', models.DateField(blank=True, null=True)),
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('subcategories', models.ManyToManyField(blank=True, to='homofix_app.subcategory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateField(auto_now_add=True)),
                ('quantity', models.IntegerField(default=1)),
                ('subcategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homofix_app.subcategory')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(auto_now_add=True)),
                ('addon_product', models.ManyToManyField(to='homofix_app.addonsproduct')),
                ('booking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homofix_app.booking')),
            ],
        ),
    ]
